            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="card card-primary">
                        ...
                        <!-- danh sach san pham -->
                        <?php
                        require_once "./projects/pi/views/default/dksp/dsdk.php";
                        require_once "./projects/pi/views/default/dksp/xacnhanmd.php";
                        ?>
                    </div>
                    <!-- /.card -->
                </div>
...
<!-- </div> -->
<?php
require_once "./projects/pi/views/default/dksp/themsp.php";
?>