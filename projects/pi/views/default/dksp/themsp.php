            ...
            <div class="modal-body">
                <form>
                    <div class="form-group">
                        <label for="dong-san-pham" class="col-form-label">Dòng sản phẩm</label>
                    ...
                    <div class="form-group">
                        <label for="ma-linh-kien" class="col-form-label">Mã linh kiện</label>
                    ...
                    <div class="form-group">
                        <label for="ma-assy" class="col-form-label">Mã Assy/Sub Assy</label>
                        <input type="text" class="form-control">
                    </div>
                    <div class="form-group">
                        <label for="ten-assy" class="col-form-label">Tên Assy/Sub Assy</label>
                        <input type="text" class="form-control">
                    </div>
                    <div class="form-group">
                        <label for="ban-ve" class="col-form-label">Bản vẽ</label>
