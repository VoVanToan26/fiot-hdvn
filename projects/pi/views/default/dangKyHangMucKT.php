            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="card card-primary">
                        ...
                        <?php
                        require_once "projects/pi/views/default/dkhmkt/dsdk.php";
                        require_once "projects/pi/views/default/dkhmkt/xacnhanmd.php";
                        ?>
                    </div>
                    <!-- /.card -->
                </div>
...
<!-- </div> -->
<?php
require_once "projects/pi/views/default/dkhmkt/themhmkt.php";
?>