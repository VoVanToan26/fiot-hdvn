...
<?php 
    ...
    //register_measurement_items
        ...
        // $sqlregister_measurement_items_name = "INSERT INTO `qc_tb_measurement_items`(`product_family`, `part_no`, `process`, `line`, `measurement_items`, `frequency`, `measuring_tools`, `standard_dimension`, `upper`, `lower`, `unit`, `type_allowance`, `form`, `x_ucl`, `x_cl`, `x_lcl`, `r_ucl`, `r_cl`, `use_formula`, `type_formula`, `number_element`, `definition_formula`, `formula`, `allowance_display`, `chart`, `management_level_one`, `no_measurement_items`, `measuring_department`, `status`, `management_level_two`, `draw`, `sig`) VALUES ('$product_family_input', '$part_no_input', '$line_input', '$process_input', '$measurment_items_name_input', '$sig')";
        // if ( mysqli_query( $connect, $sqlregister_measurement_items_name ) ) {
        //     mysqli_close( $connect );
        //     echo "<script>document.location = '" . dirname($_SERVER['SCRIPT_NAME']) . "/qc/registerPages/register_measurment_items_name'</script>"; 
        // }
