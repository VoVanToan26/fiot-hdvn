...
<!--     <div class="container-fluid">
    ...
    <form action="<?php echo dirname($_SERVER['SCRIPT_NAME']) . "/qc/registerPages/register_product_code"; ?>" method="post">
        <!-- Modal thêm sản phẩm -->
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                            ...
                            <div class="form-group">
                                <label for="user_mail_unusual_category" class="col-form-label">Mail Bất Thường Hạng Mục.</label><br>
                                <select class="form-control" id="user_mail_unusual_category[]" name="user_mail_unusual_category[]" multiple>
                                    <!-- <option value="">Select Username</option> -->
                                    <?php 
                                        for($i =0; $i <count($data_account); $i++){
                                            echo '<option value="' . $data_account[$i][1] . '">' . $data_account[$i][1] .  ' - ' . $data_account[$i][2] .  ' - ' . $data_account[$i][3] .  ' - ' . $data_account[$i][4].  ' - ' . $data_account[$i][5]. '</option>';
                            ...
                            <div class="form-group">
                                <label for="user_mail_unusual_trend" class="col-form-label">Mail Bất Thường Xu Hướng.</label><br>
                                <select class="form-control" id="user_mail_unusual_trend[]" name="user_mail_unusual_trend[]" multiple>
                                    <!-- <option value="">Select Username</option> -->
                                    <?php 
                                        for($i =0; $i <count($data_account); $i++){
                                            echo '<option value="' . $data_account[$i][1] . '">' . $data_account[$i][1] .  ' - ' . $data_account[$i][2] .  ' - ' . $data_account[$i][3] .  ' - ' . $data_account[$i][4].  ' - ' . $data_account[$i][5]. '</option>';
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" class="btn btn-primary" id="register_product" name="register_product">Đăng Ký</button>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" maxlength="20" class="form-control" id="edit_part_no" name="edit_part_no">
                            </div>
                            <div class="form-group">
                                <label for="edit_part_name" class="col-form-label">Tên Sản Phẩm.</label>
                                <input type="text" maxlength="20" class="form-control" id="edit_part_name" name="edit_part_name">
                            </div>
                            <div class="form-group">
                                <label for="edit_user_mail_approval" class="col-form-label">Mail Duyệt.</label><br>
                                <select class="form-control" id="edit_user_mail_approval[]" name="edit_user_mail_approval[]" multiple>
                                    <!-- <option value="">Select Username</option> -->
                                    <?php 
                                        for($i =0; $i <count($data_account); $i++){
                                            echo '<option value="' . $data_account[$i][1] . '">' . $data_account[$i][1] .  ' - ' . $data_account[$i][2] .  ' - ' . $data_account[$i][3] .  ' - ' . $data_account[$i][4].  ' - ' . $data_account[$i][5]. '</option>';
                            ...
                            <div class="form-group">
                                <label for="edit_user_mail_unusual_category" class="col-form-label">Mail Bất Thường Hạng Mục.</label><br>
                                <select class="form-control" id="edit_user_mail_unusual_category[]" name="edit_user_mail_unusual_category[]" multiple>
                                    <!-- <option value="">Select Username</option> -->
                                    <?php 
                                        for($i =0; $i <count($data_account); $i++){
                                            echo '<option value="' . $data_account[$i][1] . '">' . $data_account[$i][1] .  ' - ' . $data_account[$i][2] .  ' - ' . $data_account[$i][3] .  ' - ' . $data_account[$i][4].  ' - ' . $data_account[$i][5]. '</option>';
                            ...
                            <div class="form-group">
                                <label for="edit_user_mail_unusual_trend" class="col-form-label">Mail Bất Thường Xu Hướng.</label><br>
                                <select class="form-control" id="edit_user_mail_unusual_trend[]" name="edit_user_mail_unusual_trend[]" multiple>
                                    <!-- <option value="">Select Username</option> -->
                                    <?php 
                                        for($i =0; $i <count($data_account); $i++){
                                            echo '<option value="' . $data_account[$i][1] . '">' . $data_account[$i][1] .  ' - ' . $data_account[$i][2] .  ' - ' . $data_account[$i][3] .  ' - ' . $data_account[$i][4].  ' - ' . $data_account[$i][5]. '</option>';
