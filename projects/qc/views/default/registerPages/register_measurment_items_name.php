...
<div class="content-header">
    ...
    <form action="<?php echo dirname($_SERVER['SCRIPT_NAME']) . "/qc/registerPages/register_measurment_items_name"; ?>"
        method="post">
        <!-- Modal thêm sản phẩm -->
        <div class="modal fade" id="add_measurement_items_name" tabindex="-1" role="dialog"
            aria-labelledby="exadd_measurement_items_name" aria-hidden="true">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" maxlength="20" class="form-control" id="measurment_items_name_input"
                                name="measurment_items_name_input" placeholder="Nhập tên hạng mục">
                        </div>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Đóng</button>
                        <button type="submit" class="btn btn-primary" id="register_measurement_items_name_function"
                            name="register_measurement_items_name_function">Đăng ký</button>
                    </div>
                </div>
            </div>
        </div>
        ...
        <!-- Modal edit mã máy -->
        <div class="modal fade" id="edit_measurement_items_name_model" tabindex="-1" role="dialog"
            aria-labelledby="exedit_measurement_items_name" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <select class="form-control" id="product_family_edit" name="product_family_edit"
                                onchange="auto_popup_part_no('edit')">
                                <option value="">Chọn dòng sản phẩm</option>
                                <?php
                                for ($i = 0; $i < count($data_part_no); $i++) {
                                    echo '<option value="' . $data_part_no[$i] . '">' . $data_part_no[$i] . '</option>';
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" id="line_edit" name="line_edit"
                                onchange="auto_popup_process('edit')">
                                <option value="">Chọn line</option>
                                <?php
                                for ($i = 0; $i < count($data_line); $i++) {
                                    echo '<option value="' . $data_line[$i] . '">' . $data_line[$i] . '</option>';
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" maxlength="20" class="form-control" id="measurment_items_name_edit"
                                name="measurment_items_name_edit" placeholder="Nhập tên hạng mục">
                        </div>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Đóng</button>
                        <button type="submit" class="btn btn-primary" id="edit_measurement_items_name_function"
                            name="edit_measurement_items_name_function">Sửa</button>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="modal-content bg-danger">
                    ...
                    <div class="modal-footer justify-content-between">
                        ...
                        <button type="submit" class="btn btn-outline-light"
                            name="delete_measurement_items_name_function"
                            id="delete_measurement_items_name_function">Xóa</button>
                    </div>
                </div>
                <!-- /.modal-content -->
            </div>
