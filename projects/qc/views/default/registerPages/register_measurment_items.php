...
<!--     <div class="container-fluid">
    ...
    <form action="<?php echo dirname($_SERVER['SCRIPT_NAME']) . "/qc/registerPages/register_measurment_items"; ?>" method="post" enctype="multipart/form-data">
        <!-- Modal thêm sản phẩm -->
        <div class="modal fade" id="add_measurement_items" tabindex="-1" role="dialog" aria-labelledby="exadd_measurement_items"
            aria-hidden="true">
            <div class="modal-dialog modal-xl" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div  class="row">
                            ...
                            <div class="form-group col-3">
                                ...
                                <select class="form-control" id="line_input" name="line_input" onchange="auto_popup_part_no('register');">
                                    <option value="">Vui lòng chọn dòng sản phẩm trước</option>
                                </select>
                            </div>
                            <div class="form-group col-3">
                                <label for="part_no_input" class="col-form-label">Mã Sản Phẩm</label>
                                <select class="form-control" id="part_no_input" name="part_no_input" onchange="auto_popup_process('register');">
                            ...
                            <div class="form-group col-3">
                                ...
                                <select class="form-control" id="process_input" name="process_input" onchange="auto_popup_measurement_items('register');">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        ...
                                        <div class="row" style="border-style: ridge; border-width: 1px; border-color: #808080;">
                                            ...
                                            <div class="col-6 col-form-label">
                                                <img src="#" alt="" id="img-draw_input" style="display:none; height: 38px; max-width:70px;">
                                            </div>
                                            <div class="col-3">
                                    ...
                                    <div class="col-12">
                                        <small class="form-text text-muted">Vui lòng chọn file có định dạng ".jpg, .jpeg, .png".
                                                ...
                                                quá 5mb và không chứa các ký tự đặc biệt.</small>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="form-group col-3">
                                ...
                                <select class="form-control" id="chart_input" name="chart_input" onchange="chart_input_change()">
                            ...
                            <div class="form-group col-3">
                                ...
                                <select class="form-control" id="measuring_department_input" name="measuring_department_input">
                            ...
                            <div class="form-group col-3">
                                ...
                                <input type="text" class="form-control" id="no_measurment_items_input" name="no_measurment_items_input" value="<?php echo ($data_measurement_items[count($data_measurement_items)-1][0]+1); ?>" readonly>
                            </div>
                            <div class="form-group col-3">
                                <label for="measurement_items_input" class="col-form-label">Hạng Mục Đo</label>
                                <select class="form-control" id="measurement_items_input" name="measurement_items_input">
                                    <option value="">Vui lòng chọn công đoạn trước</option>
                                </select>
                            </div>
                        </div>
                        <div class="row">
                            <div class="form-group col-3">
                                ...
                                <select class="form-control" id="form_input" name="form_input" onchange="form_input_change()">
                            ...
                            <div class="form-group col-3">
                                ...
                                <input type="text" class="form-control" id="allowance_display_input" name="allowance_display_input" maxlength="10" autocomplete="off">
                            </div>
                        </div>
                        <div class="row x_ucl_form">
                            <div class="form-group col">
                                <label for="x_ucl_input" class="col-form-label">X-UCL</label>
                                <input type="text" class="form-control" id="x_ucl_input" name="x_ucl_input" maxlength="10" autocomplete="off">
                            </div>
                            <div class="form-group col">
                                <label for="x_cl_input" class="col-form-label">X-CL</label>
                                <input type="text" class="form-control" id="x_cl_input" name="x_cl_input" maxlength="10" autocomplete="off">
                            </div>
                            <div class="form-group col">
                                <label for="x_lcl_input" class="col-form-label">X-LCL</label>
                                <input type="text" class="form-control" id="x_lcl_input" name="x_lcl_input" maxlength="10" autocomplete="off">
                            </div>
                            <div class="form-group col">
                                <label for="r_ucl_input" class="col-form-label">R-UCL</label>
                                <input type="text" class="form-control" id="r_ucl_input" name="r_ucl_input" maxlength="10" autocomplete="off">
                            </div>
                            <div class="form-group col">
                                <label for="r_cl_input" class="col-form-label">R-CL</label>
                                <input type="text" class="form-control" id="r_cl_input" name="r_cl_input" maxlength="10" autocomplete="off">
                            </div>
                        </div>
                        <div class="row">
                            <div class="form-group col">
                                <label for="type_allowance_input" class="col-form-label">Loại Quy Cách</label>
                                <select class="form-control" id="type_allowance_input" name="type_allowance_input" maxlength="10" autocomplete="off" onchange="type_allowance_input_change()">
                            ...
                            <div class="form-group col standard_dimension_input_form">
                                ...
                                <input type="text" class="form-control" id="standard_dimension_input" name="standard_dimension_input" maxlength="10" autocomplete="off">
                            </div>
                            <div class="form-group col upper_input_form">
                                <label for="upper_input" class="col-form-label">Cận Trên</label>
                                <input type="text" class="form-control" id="upper_input" name="upper_input" maxlength="10" autocomplete="off">
                            </div>
                            <div class="form-group col lower_input_form">
                                <label for="lower_input" class="col-form-label">Cận Dưới</label>
                                <input type="text" class="form-control" id="lower_input" name="lower_input" maxlength="10" autocomplete="off">
                            </div>
                            <div class="form-group col">
                                <label for="unit_input" class="col-form-label">Đơn Vị</label>
                                <input type="text" class="form-control" id="unit_input" name="unit_input" maxlength="10" autocomplete="off">
                            </div>
                        </div>
                        <div class="row">
                            <div class="form-group">
                                <div class="custom-control custom-switch">
                                    <input class="custom-control-input" type="checkbox" id="use_formula_input" name="use_formula_input" onclick="FormulaCb_function()">
                        ...
                        <div class="row form_formula d-none">
                            <div class="col-6">
                                <div class="row">
                                    <div class="col-6 form-group">
                                        <label for="type_formula_input" class="col-form-label">Chọn Dạng Công Thức</label>
                                        <select class="form-control" id="type_formula_input" name="type_formula_input" onchange="type_formula_input_change(); number_element_input_change()">
                                    ...
                                    <div class="col-6 form-group number_element_input_form">
                                        ...
                                        <input type="number" class="form-control" id="number_element_input" name="number_element_input" max="10" min="1" value="1" onchange="number_element_input_change();" readonly>
                                    </div>
                                    <div class="col-12 form-group formula_input_form">
                                        ...
                                        <div class="d-flex flex-row">
                                            ...
                                            <input type="text" class="form-control w-75" id="formula_input" name="formula_input" maxlength="50" autocomplete="off">
                                        </div>
                            ...
                            <div class="col-6 form-group table-responsive formula_info_form">
                                <table class="table-cong-thuc table table-bordered text-center mt-38">
                                    ...
                                    <tr class="b_form">
                                        <td>B</td>
                                        <td><input type="text" class="form-control" id="definition_formula_input_one" name="definition_formula_input_one" maxlength="20" autocomplete="off"></td>
                                    </tr>
                                    <tr class="d-none c_form">
                                        <td>C</td>
                                        <td><input type="text" class="form-control" id="definition_formula_input_two" name="definition_formula_input_two" maxlength="20" autocomplete="off"></td>
                                    </tr>
                                    <tr class="d-none d_form">
                                        <td>D</td>
                                        <td><input type="text" class="form-control" id="definition_formula_input_three" name="definition_formula_input_three" maxlength="20" autocomplete="off"></td>
                                    </tr>
                                    <tr class="d-none e_form">
                                        <td>E</td>
                                        <td><input type="text" class="form-control" id="definition_formula_input_four" name="definition_formula_input_four" maxlength="20" autocomplete="off"></td>
                                    </tr>
                                    <tr class="d-none f_form">
                                        <td>F</td>
                                        <td><input type="text" class="form-control" id="definition_formula_input_five" name="definition_formula_input_five" maxlength="20" autocomplete="off"></td>
                                    </tr>
                                    <tr class="d-none g_form">
                                        <td>G</td>
                                        <td><input type="text" class="form-control" id="definition_formula_input_six" name="definition_formula_input_six" maxlength="20" autocomplete="off"></td>
                                    </tr>
                                    <tr class="d-none h_form">
                                        <td>H</td>
                                        <td><input type="text" class="form-control" id="definition_formula_input_seven" name="definition_formula_input_seven" maxlength="20" autocomplete="off"></td>
                                    </tr>
                                    <tr class="d-none i_form">
                                        <td>I</td>
                                        <td><input type="text" class="form-control" id="definition_formula_input_eight" name="definition_formula_input_eight" maxlength="20" autocomplete="off"></td>
                                    </tr>
                                    <tr class="d-none j_form">
                                        <td>J</td>
                                        <td><input type="text" class="form-control" id="definition_formula_input_nine" name="definition_formula_input_nine" maxlength="20" autocomplete="off"></td>
                                    </tr>
                                    <tr class="d-none k_form">
                                        <td>K</td>
                                        <td><input type="text" class="form-control" id="definition_formula_input_ten" name="definition_formula_input_ten" maxlength="20" autocomplete="off"></td>
                                    </tr>
                                </table>
                            </div>
                        </div>
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" class="btn btn-primary" id="register_measurement_items_function" name="register_measurement_items_function">Đăng ký</button>
                    </div>
                </div>
            </div>
        </div>
...
<script type="text/javascript">
    ...
    function form_input_change() {
        ...
        var x_ucl_form = document.querySelector('.x_ucl_form');
        if( form_input == "Datasheet" || form_input == "Checksheet" || chart_input == "Biểu đồ điều tra năng lực công đoạn"){
            x_ucl_form.classList.add('d-none');
            document.getElementById("x_ucl_input").disabled = true;
            document.getElementById("x_cl_input").disabled = true;
            document.getElementById("x_lcl_input").disabled = true;
    ...
    function auto_popup_measurement_items(action) {
        if(action == "register"){
            ...
            if(product_family == ""){
                ...
                // xmlhttp.open("GET", url, true);
                var link_get_data = "<?php echo dirname($_SERVER['SCRIPT_NAME']) . '/qc/autopopup' ?>";
                xmlhttp.open("GET", link_get_data + "?auto_popup_measurement_items=yes&product_family=" + product_family + "&part_no=" + selectPart_no + "&line=" + selectLine + "&process=" + selectProcess, true);
                xmlhttp.send();
            }
        }
         
    }
    function editMeasurmentItemsName(id_edit, product_family_edit, part_no_edit, line_edit, process_edit, measurement_items_edit) {
